            ...
            <div class="card-body">
                ...
                <nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List Toko Saya pada Platform Shopee</li>
                    </ol>
                </nav>
                ...
                <table class="table table-bordered" width="100%">
                    ...
                    <tbody>
                        ...
                        if (!isset($pager)) {
                            ...
                            $page  = $pager->getCurrentPage('toko_shopee') ?? 1;
                            $limit = $pager->getPerPage('toko_shopee') ?? 5;
                            $no    = 1 + (($page - 1) * $limit);
                        }
                        ?>
                        ...
                        <?php foreach ($toko as $t): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <!-- TOGGLE AKTIF -->
                                    <?php if ($t['is_active'] == 1): ?>
                                        <a href="<?= base_url('shopee/toko/deactivate/' . $t['id_toko']) ?>"
                                            class="btn btn-success btn-sm"
                                            title="Nonaktifkan">
                                            <i class="fa fa-toggle-on"></i>
                                        </a>
                                    <?php else: ?>
                                        <a href="<?= base_url('shopee/toko/activate/' . $t['id_toko']) ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Tambah Toko Shopee</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span>&times;</span>
                </button>
            </div>

            <form action="/shopee/toko/store" method="post">
                <?= csrf_field() ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            value="<?= $id_toko_auto ?>" readonly style="background:#f8f9fa">
                        <input type="hidden" name="id_toko" value="<?= $id_toko_auto ?>">
                    </div>
    ...
    <div class="modal fade" id="editTokoModal<?= $t['id_toko'] ?>" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/shopee/toko/update/<?= $t['id_toko'] ?>" method="post">
                    <?= csrf_field() ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <strong><?= esc($t['nama_toko']) ?></strong>?
                </div>

                <div class="modal-footer">
                    <button class="btn btn-secondary" data-dismiss="modal">Batal</button>
                    <a href="/shopee/toko/delete/<?= $t['id_toko'] ?>" class="btn btn-danger">Hapus</a>
                </div>
